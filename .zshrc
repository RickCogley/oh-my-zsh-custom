...
plugins=(rickcogley ackgrep pipe directory git git-extras github colored-man colorize brew osx zsh-syntax-highlighting jira heroku chucknorris coffee node dircycle dirhistory docker lol rand-quote screen atom)
